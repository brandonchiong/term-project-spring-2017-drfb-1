...
INSERT INTO Cards (id, card_type, color, number, image) VALUES
  ...
  (21, 'reverse', 'r', -2, '/images/UnoCard/redReverse.png'),
  (22, 'reverse', 'r', -2, '/images/UnoCard/redReverse.png'),
  (23, 'draw2','r', -3, '/images/UnoCard/redDraw2.png'),
  (24, 'draw2','r', -3, '/images/UnoCard/redDraw2.png'),
  (25, 'wild', 'w', -4, '/images/UnoCard/wild.png'),
  (26, 'wild4', 'w', -4, '/images/UnoCard/wildDraw4.png'),
  ...
  (48, 'reverse', 'y', -2, '/images/UnoCard/yellowReverse.png'),
  (49, 'reverse', 'y', -2, '/images/UnoCard/yellowReverse.png'),
  (50, 'draw2','y', -3, '/images/UnoCard/yellowDraw2.png'),
  (51, 'draw2','y', -3, '/images/UnoCard/yellowDraw2.png'),
  (52, 'wild', 'w', -4, '/images/UnoCard/wild.png'),
  (53, 'wild4', 'w', -4, '/images/UnoCard/wildDraw4.png'),
  ...
  (75, 'reverse', 'g', -2, '/images/UnoCard/greenReverse.png'),
  (76, 'reverse', 'g', -2, '/images/UnoCard/greenReverse.png'),
  (77, 'draw2','g', -3, '/images/UnoCard/greenDraw2.png'),
  (78, 'draw2','g', -3, '/images/UnoCard/greenDraw2.png'),
  (79, 'wild', 'w', -4, '/images/UnoCard/wild.png'),
  (80, 'wild4', 'w', -4, '/images/UnoCard/wildDraw4.png'),
  ...
  (102, 'reverse', 'b', -2, '/images/UnoCard/blueReverse.png'),
  (103, 'reverse', 'b', -2, '/images/UnoCard/blueReverse.png'),
  (104, 'draw2','b', -3, '/images/UnoCard/blueDraw2.png'),
  (105, 'draw2','b', -3, '/images/UnoCard/blueDraw2.png'),
  (106, 'wild', 'w', -4, '/images/UnoCard/wild.png'),
  (107, 'wild4', 'w', -4, '/images/UnoCard/wildDraw4.png');
